...
- [ ] a) Chave estrangeira
- [ ] b) Chave primária, pois identifica de forma única cada linha (registro) de uma tabela do modelo relacional
...
- [ ] c) Criar uma tabela associativa com as chaves estrangeiras das duas entidades
